...
class ProjectBlock extends BaseBlockService implements BlockServiceInterface {
    ...
    public function execute(BlockContextInterface $blockContext, Response $response = null) {
        ...
        $repository = $this->em->getRepository("SinencoProjectBundle:Project");
        ...
        foreach($projects as $project){
            $numbers[$project->getState()]++;
        }
        
        $settings = $blockContext->getSettings();
        
        $settings["color"] = "bg-aqua" ;
        $settings["number"] = "<span class='text-orange'>".$numbers[0]." / ".$numbers[1]."</span> / <span class='text-success'>".$numbers[2]."</span> / <span class='text-danger'>".$numbers[3]."</span>" ;
        $settings["path"] = "" ;
