...
set :repository, "git@bitbucket.org:jordanDEGEA/sinenco.git" # L’URL de votre repository
...
set :shared_children, [app_path + "/logs", "vendor", "web/uploads"] # Idem, mais pour les dossiers
